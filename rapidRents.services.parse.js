  (function () {
            ...
            function ParseUtilityFactory() {
                ...
                var aRapidRentsUtilityObject = this;
                aRapidRentsUtilityObject.parse = _internalParse;


                function _internalParse(opts) {

                    var file = document.querySelector(opts.RapidREntsFileId).files[0];
                    $(opts.rapidRentsFileId).parse(opts);
                }

                return aRapidRentsUtilityObject;
            }
  })();
  ...
  (function () {
      ...
      function ImportPropertyServiceFactory($baseService) {
          ...
          var aRapidREntsServiceObject = rapidRents.services.importedProperties;
