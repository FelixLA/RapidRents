(function () {
    ...
    function NavController(
        ...
        function _checkForUser() {
            ...
            if (!vm.$sabio.baseViewModel) {
                vm.$log.log("No user signed in");
                vm.$systemEventService.listen("login", _onTestSystemEvent);
                return;
            }

            vm.isLoggedIn = vm.$sabio.baseViewModel.isLoggedIn;

            if (vm.isLoggedIn) {
                vm.$log.log(vm.$sabio.baseViewModel.currentUser.userName);

                vm.signedInUser.displayName = vm.$sabio.baseViewModel.currentUser.userName;
            }
